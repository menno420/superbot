...
done-when: both trigger records are disposed (deleted, or annotated-and-left-paused with the decision recorded in `docs/operations/autonomous-routines.md`) and the L395/L406 doc drift is annotated; the executing session's card cites this ORDER.
