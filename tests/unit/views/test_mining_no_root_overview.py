...
def test_mining_hub_view_button_count_after_overview_removal():
    """Fourteen action buttons, no Overview: the six core actions (Mine /
    Harvest / Explore / Inventory / Stats / Build), Workshop, the two
    depth-navigation buttons (Descend / Ascend), Market, Vault, Gear, Recipes,
    and Character. The count is pinned so an accidental no-op control can't
    creep back in.
    """
    view = MiningHubView()
