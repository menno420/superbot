...
_EXPECTED = [
    ...
    ("nk_btd6_bosses_leaderboard", "/btd6/bosses/:bossID/leaderboard/:type/:teamSize"),
    ("nk_btd6_bosses_metadata", "/btd6/bosses/:bossID/metadata/:difficulty"),
    ("nk_btd6_users", "/btd6/users/:userID"),
    ("nk_btd6_challenges", "/btd6/challenges"),
    ("nk_btd6_challenges_filter", "/btd6/challenges/filter/:challengeFilter"),
    ...
    ("nk_btd6_ct_lb_group", "/btd6/ct/:ctID/leaderboard/group/:groupID"),
    ("nk_btd6_guild", "/btd6/guild/:guildID"),
    ("nk_btd6_odyssey", "/btd6/odyssey"),
    ("nk_btd6_odyssey_diff", "/btd6/odyssey/:odysseyID/:difficulty"),
    ("nk_btd6_odyssey_diff_maps", "/btd6/odyssey/:odysseyID/:difficulty/maps"),
...
def test_seed_inserts_every_planned_endpoint():
    ...
    assert (
        not missing
    ), "Seed inserts in migration 040 are missing endpoints: " + ", ".join(missing)
