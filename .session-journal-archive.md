...
- **Plan:** `docs/health/bot-awareness-implementation-plan.md` (approved); banner added atop the
  Codex map `docs/health/bot-awareness-diagnostics-plan.md`. AI-assisted diagnostics OVER the
...
- **Scope:** dedicated Claude Opus planning session refining Codex's stability pre-impl
  ...
  `docs/archive/stability-implementation-plan-refined-2026-06-05.md`. No source implemented.
...
- **Scope:** planning/verification only; wrote `docs/archive/stability-preimplementation-plan-2026-06-05.md` for the Opus refinement session.
...
- **Shipped (branch `claude/charming-ride-7Whiq`):**
  ...
  - `docs`: seeded `docs/archive/cog-functionality-audit-2026-06-05.md` (full per-cog
...
- Added `docs/ai/ai-tool-capability-roadmap.md`: a non-authoritative, source-verified roadmap
