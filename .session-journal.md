...
- **Live env — CORRECTION to the entry below:** *this* editing container **does** expose the
...
- **Checks:** `check_architecture.py --mode strict` = 0 errors; `check_quality.py --full` = GREEN
  (7461 passed, 3 skipped, 20 warnings). Open PRs: **only #530** (docs-only journal; no source
  overlap); `main` == `5e62578` (== branch HEAD), has not moved past #529.
