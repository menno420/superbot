...
| **Prod down (Railway build failed)** | Read the build log first. `mise … no precompiled python found` = the Python-pin race → [`docs/production-deployment.md`](docs/production-deployment.md) (pin + bump procedure). Postgres "Online" ≠ bot running. |
