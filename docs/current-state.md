...
- **#1208 · #1213 (2026-06-21, creature game — design → runtime)** — **catch + collection/dex** shipped as the
  ...
  user-facing PvP flow is **in flight** (#1230). [plan](planning/creature-game-design-and-sim-2026-06-20.md) §4.
