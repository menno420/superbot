...
>
> **Last updated:** 2026-06-14, **hardening P0-4 PR 2 — channel creation + category lifecycle
...
- **Older merges (#754 … #535) → [`current-state-archive.md`](current-state-archive.md).** Recently-shipped keeps the ~20 newest; older entries are archived (`scripts/check_docs.py` soft-ratchets the count). *(The #746–#754 entry was archived 2026-06-14 to offset the #825 entry added above; the #741/#742/#745/#748 entries were archived earlier the same day by the band-#820 reconciliation pass — keeping the live ledger at the ratchet of 20.)*
