...
> 3. **AI tooling (orchestration + answerability)** — orchestration Phases 1–3 shipped (**#612**, **#618**, **#619** — including the gate-lifted `ai:tools` Tools & Workflows operator UI; default byte-identical); answerability Phase 1A/1B (**#612**, Q-0043: range cash **inclusive**) + Phase 2 read model (**#616**) shipped. **Next:** orchestration **Phase 4** (complex-BTD6 plan/execute/verify workflow + typed answer contracts + the deferred §12.1 durable audit trace — MVP slice now proposed as **Q-0048**, one-line confirm) and/or answerability **Phase 3** (the scope-filtered self-awareness tools exposing the read model — net-new AI **exposure**: gate lift + tool list now proposed as **Q-0047**, one-line confirm). Plans: [`ai/ai-complex-request-tool-orchestration-plan.md`](ai/ai-complex-request-tool-orchestration-plan.md) · [`planning/ai-btd6-answerability-roadmap-2026-06-09.md`](planning/ai-btd6-answerability-roadmap-2026-06-09.md).
>
