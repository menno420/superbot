...
>
> **▶ Next action — one live queue:** **NINETEENTH Q-0107 PASS DONE (2026-06-21, band-#1260, issue #1264 — [pass record + next-band queue](planning/reconciliation-pass-2026-06-21-band1260.md)).** This band's two headlines: (1) the **reaction-roles arc matured past the overhaul's PR 1–5** — multi-emote-per-message + menu reuse (#1234), channel/message pickers (#1237/#1243), role presets + management UX (#1245), gradient presets (#1246), free temp-roles member view (#1242), and **dead-binding self-heal** on both the cleanup (#1248) and live-listener (#1250) paths; and (2) a long **BTD6 data-lifecycle session** — buff-uptime upgrade-detail model + AI tool (#1235/#1249/#1251) and **auto-seed/drift/changed-report** hardening (#1255/#1258/#1263) that closes the "owner must remember `seed-data`" manual step. Also shipped: a **NEW Project Moon knowledge-domain program** stood up as design (wiki-feasibility idea #1238 → full-parity plan Q-0192 #1239 → pre-build recon + `KnowledgeDomain` seam #1240); the **creature-PvP leaderboard provider** (#1244); the **Starboard/Hall-of-Fame** lane (plan #1254 → PR 1 #1259 → **PR 2 #1270** — self-star exclusion + ignore-channels + a `BaseView` config panel; XP-bonus deferred to an owner-gated PR 3); and **Q-0193 merge=deploy clarity** (#1247 — Railway auto-redeploys on merge; never tell the owner to "restart/deploy"). **No PLAN-BACKLOG-THIN flag** — buildable depth is well over the cadence (Project-Moon runtime build is multi-PR · Starboard PR 2 · botsite-React migration · consistency-linter AI-nav PR 1 · procedures→skills Batch 2 · creature leaderboards/ranked). **Honest caveat (carried):** the *cleanly-ungated self-merge* subset stays thinner than the headline — most depth is runtime / `needs-hermes-review`, so an empty *autonomous* fire should prefer a substantial review-gated lane or promote a fresh idea → plan → build (Q-0172). **▶ Next ungated startable = ONE of:** (a) **Project Moon runtime PR 1** — the `KnowledgeDomain` seam + first ingest, the band's newest large lane ([plan](planning/project-moon-knowledge-domain-plan-2026-06-21.md)); (b) the **botsite React-SPA migration** ([plan](planning/botsite-react-spa-migration-plan-2026-06-20.md)); (c) a substantial **`needs-hermes-review`** lane — consistency-linter **AI-nav PR 1** ([plan](planning/ai-panel-inplace-navigation-plan-2026-06-19.md)) or **procedures→skills Batch 2** ([plan](planning/procedures-to-skills-conversion-plan-2026-06-17.md)); or (d) promote a fresh `docs/ideas/` idea → plan → build (Q-0172). In flight (don't duplicate): reaction-roles PR 6 #1279 (this dispatch run — optional PIL banner cards, ⚑ self-initiated, `needs-hermes-review`, auto-merge OFF). Owner-paced/gated: reaction-roles web builder (Surface A) · creature PvP balance + art (Q-0187) · website rollout · [feedback-board PR 1](planning/feedback-board-generalization-plan-2026-06-19.md) (owner auth) · AI-ticket build (Q-0183) · Explore-hub PR 2 + gated layers (Q-0182) · dashboard writes/control-API (security review). *(Trust THIS line + the Recently-shipped list, never a lower "next ▶" in the historical narrative below.)*
>
...
>
> **Last updated:** 2026-06-21 — **nineteenth Q-0107 reconciliation pass (band-#1260, issue #1264
> — [pass record](planning/reconciliation-pass-2026-06-21-band1260.md));** the live state is the
> **▶ Next action** line above + the Recently-shipped list. *(The dated narrative below is historical —
> passes 10–19 record their state in the ▶ Next action callout + their per-band pass records, not here.)*
...
>
> **Last reconciliation pass:** PR #1263 (2026-06-21, nineteenth Q-0107 cadence pass, band-#1260 —
> [the pass record + next-band queue](planning/reconciliation-pass-2026-06-21-band1260.md)). The next
> **docs-only review + planning reconciliation** is due once merged PRs cross #1290 (every
...
- **Older merges (#1186 … #535) → [`current-state-archive.md`](current-state-archive.md).** Recently-shipped keeps the ~20 newest; older entries are trimmed to the archive (newest-first), which `scripts/check_docs.py` soft-ratchets at 20 and `check_current_state_ledger.py` treats as present. *(Thematic grouping by date means the live/archive PR-number spans overlap slightly — the floor pointer is approximate prose, not a strict bound; the per-band pass records carry the exact moved sets.)* *(The nineteenth Q-0107 pass — band-#1260, 2026-06-21 — added the band #1234–#1263 work as six grouped entries (BTD6 buff-uptime + data auto-seed #1235/#1249/#1251/#1255/#1258/#1263, reaction-roles continuation #1234/#1237/#1242/#1243/#1245/#1246/#1248/#1250, Project Moon design #1238/#1239/#1240, creature leaderboard + Starboard plan #1244/#1254, workflow/docs #1247/#1253/#1256, dashboard-refresh #1236/#1241/#1252); trimmed the live ledger to 20, moving #1186 · #1156-band · #1147-band · #1143-band · #1162-band · #1149-band to the archive.)* *(The eighteenth Q-0107 pass — band-#1230, 2026-06-21 — added the band #1203–#1231 work as seven grouped entries; trimmed the live ledger to 20, moving #1169 · #1145-band · #1142 · #1135-band · #1131 · #1132 · #1130 to the archive.)*
