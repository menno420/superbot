...
> |---|---|---|
> | **S1 Bot product** | [`current-state/S1-bot.md`](current-state/S1-bot.md) | reaction-roles arc Carl-bot-mature; creature game + mining grid live; Starboard PR 1+2 shipped (#1259/#1270); karma shipped (#1332); ▶ **consolidation/discoverability audit** ([brief](planning/consolidation-discoverability-audit-brief-2026-06-23.md)) / Project Moon runtime PR 1 / botsite React migration |
