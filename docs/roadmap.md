...
- **Next** — **implement the verified mapping batches**: the one active queue is the
  ...
  what remains is Batch 9's RS05/RS10 (contract-first); the Help overlay
  editor UI executed same day (PR A #677 + PR B #679).
