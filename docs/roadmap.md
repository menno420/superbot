...
> [`planning/reconciliation-pass-2026-06-12-night.md`](planning/reconciliation-pass-2026-06-12-night.md)
> §4 — set by the second Q-0107 pass (the carried hardening spine + the Q-0108–Q-0112
> safety/community lane). That doc owns the queue; this page stays the per-area index. (The
> 2026-06-13 interim [workflow reconciliation](planning/reconciliation-pass-2026-06-13-workflow.md)
> did not change the queue — docs/tooling only.)
>
