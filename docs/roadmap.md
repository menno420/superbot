...
- **Now (executing 2026-06-13 — #809)** — the
  ...
  `check` CLI); **PR 2 is landing in increments** — **stances (#805 — §3b) + skills (#809 — §3c) shipped**.
