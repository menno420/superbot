...
- **Next (foundation built)** — [Help cog customization audit and roadmap](planning/help-cog-customization-audit-2026-06-09.md): the **catalogue/projection seam shipped 2026-06-10 in #657** (audit Phases 1+2 — all five render paths consume one `HelpProjection`; verify merged); the remaining piece is the **HLP-3 guild overlay/editor** (rename/hide/order) — Q-0055–Q-0059 all answered, activation gated only on #657 being merged + smoke-tested.
