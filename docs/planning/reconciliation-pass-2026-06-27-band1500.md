...
> **Status:** `historical` — superseded by the [band-#1530 pass](reconciliation-pass-2026-06-28-band1530.md).
> The docs-only review + planning pass for the band that crossed **#1500**
