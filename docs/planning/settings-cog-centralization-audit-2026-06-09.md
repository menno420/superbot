...
> **Status:** `historical` — source-verified mapping and implementation roadmap; no runtime changes in this session.
> **Superseded 2026-06-19 (was active):** Phases 0+1 shipped #640; Phase 2/3 convergence → settings-pointer-lane-convergence-plan. Do not act on this — current map: [planning/README](README.md).
