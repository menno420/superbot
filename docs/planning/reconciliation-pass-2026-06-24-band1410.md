...
> **Status:** `historical` — superseded by the [band-#1440 pass](reconciliation-pass-2026-06-24-band1440.md).
> The docs-only review + planning pass for the band that crossed **#1410**
