...
> **Status:** `historical` — superseded by [the band-#1500 pass](reconciliation-pass-2026-06-27-band1500.md).
> The docs-only review + planning pass for the band that crossed **#1470**
