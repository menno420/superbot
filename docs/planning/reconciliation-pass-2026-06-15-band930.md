...
> **Status:** `historical` — superseded by [the band-#990 pass](reconciliation-pass-2026-06-16-band990.md)
> (2026-06-16, tenth Q-0107 cadence fire). The docs-only review + planning pass for the band that crossed
