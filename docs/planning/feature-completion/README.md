...
**36 units · 0 certified (0%) · 1 assessed · 35 unassessed.**
...
| Casino (poker) | game | competitive | unassessed | — |
| Deathmatch | game | competitive | unassessed | — |
| RPS / tournament | game | competitive | unassessed | — |

### Games — activity / idle

| Unit | Type | Family | State | Certificate |
|---|---|---|---|---|
| Mining | game | activity | unassessed | — |
| Fishing | game | activity | unassessed | — |
| Chicken farm | game | activity | unassessed | — |
| Creatures | game | activity | unassessed | — |
| Counting | game | activity | unassessed | — |
| Word chain | game | activity | unassessed | — |

### Moderation & safety

| Unit | Type | Family | State | Certificate |
|---|---|---|---|---|
| Moderation | server-fn | moderation | unassessed | — |
| Cleanup | server-fn | moderation | unassessed | — |
| Automod | server-fn | moderation | unassessed | — |
| Image moderation | server-fn | moderation | unassessed | — |
| Security | server-fn | moderation | unassessed | — |
| Proof channel | server-fn | moderation | unassessed | — |

### Economy & progression

| Unit | Type | Family | State | Certificate |
|---|---|---|---|---|
| Economy | server-fn | economy | unassessed | — |
| Inventory | server-fn | economy | unassessed | — |
| Treasury | server-fn | economy | unassessed | — |
| XP & levels | server-fn | progression | unassessed | — |
| Karma | server-fn | progression | unassessed | — |
| Leaderboards | server-fn | progression | unassessed | — |

### Community

| Unit | Type | Family | State | Certificate |
|---|---|---|---|---|
| Welcome | server-fn | community | unassessed | — |
| Support tickets | server-fn | community | unassessed | — |
| Community spotlight | server-fn | community | unassessed | — |
| Counters | server-fn | community | unassessed | — |

### Server management

| Unit | Type | Family | State | Certificate |
|---|---|---|---|---|
| Roles | server-fn | management | unassessed | — |
| Channels | server-fn | management | unassessed | — |
| Setup wizard | server-fn | management | unassessed | — |

### Platform & meta

| Unit | Type | Family | State | Certificate |
|---|---|---|---|---|
| AI assistant | server-fn | platform | unassessed | — |
| Logging | server-fn | platform | unassessed | — |
| Settings | server-fn | platform | unassessed | — |
| Diagnostics | server-fn | platform | unassessed | — |
| Utility | server-fn | platform | unassessed | — |
| Help | server-fn | platform | unassessed | — |
| Admin | server-fn | platform | unassessed | — |
