...
| [round3-founding-package-idea-engine](round3-founding-package-idea-engine-2026-07-10.md) | founding package for the Idea Engine Project (standing-core seat, now Q-0261 seat 4): role-scoped instructions + coordinator brief with baked-in routine + env (existing `superbot` env); probe battery v0 | `idea-probe-brainstorm-simulator` (`../ideas/idea-probe-brainstorm-simulator-2026-07-10.md`) |
