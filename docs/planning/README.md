...
| [karma-reputation](karma-reputation-plan-2026-06-22.md) | **owner-directed, plan-first** — thanks/upvote peer reputation (per-user totals + leaderboard provider on an audited mutation seam, modelled on economy/XP). 2–3 PRs; **gate:** 5 owner design Qs (grant surface · downvotes · pure-rep vs. economy · karma-roles · defaults) | community lane · `karma-reputation-system` |
