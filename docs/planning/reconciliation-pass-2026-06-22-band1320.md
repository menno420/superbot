...
> **Status:** `historical` — superseded by [the band-#1350 pass](reconciliation-pass-2026-06-23-band1350.md). The docs-only review + planning pass for the band that crossed **#1320**
