...
| Cog integration helpers: `build_help_menu_view`, `build_platform_help_menu_view`, `_governance_context_for`, `setup` | `disbot/cogs/diagnostic_cog.py` | cog functions | **Done** | Help integration, governance context, extension setup, and recent-error provider registration are explicit. | `diagnostic_cog.py:87-148`, `698-741` |
