# Program launch index — the four program sessions (2026-07-07; re-cut per Q-0253)

> **Status:** `plan` — the one-page index for the owner directives **Q-0252 + Q-0253**: the
> dedicated sessions that turn the three-build program into repos and plans. Paste each session's
> prompt from its brief; every session runs under Q-0241 (never-wait, decide-and-flag,
> silence = consent). All program rulings from 2026-07-07 bind: **Q-0243…Q-0253**.
> *(Re-cut 2026-07-07, Q-0253: today is the last Fable-subscription day for a while — Fable goes
> to design + deep planning; the mechanical kickoff demotes to Opus-class. Originally three
> sessions; now four.)*

| # | Session | Model | Brief (paste-ready prompt inside) | Produces |
|---|---|---|---|---|
...
sequenced per Q-0247 rail-before-scale regardless of planning order. The plans land in THIS
