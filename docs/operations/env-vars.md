...
| Variable | Layers | Usages |
|---|---|---|
| `AI_DEFAULT_PROVIDER` | config, core | `disbot/config.py:168` *(default)*<br>`disbot/core/runtime/ai/feature_flags.py:66` *(default)* |
| `AI_ENABLED` | config | `disbot/config.py:167` *(default)* |
| `AI_FALLBACK_PROVIDER` | core | `disbot/core/runtime/ai/routing.py:128` *(default)* |
| `ANTHROPIC_API_KEY` | config, core | `disbot/config.py:151` *(default)*<br>`disbot/core/runtime/ai/providers/anthropic_provider.py:93` *(default)* |
...
| `BTD6_AUTO_SEED` | config | `disbot/config.py:206` *(default)* |
...
| `BTD6_DATA_BACKEND` | config | `disbot/config.py:194` *(default)* |
| `BTD6_DATA_BASE_URL` | config | `disbot/config.py:197` *(default)* |
| `BTD6_DATA_CACHE_DIR` | config | `disbot/config.py:200` *(default)* |
