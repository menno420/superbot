...
| Variable | Layers | Usages |
|---|---|---|
| `AI_DEFAULT_PROVIDER` | config, core | `disbot/config.py:178` *(default)*<br>`disbot/core/runtime/ai/feature_flags.py:66` *(default)* |
| `AI_ENABLED` | config | `disbot/config.py:177` *(default)* |
| `AI_FALLBACK_PROVIDER` | core | `disbot/core/runtime/ai/routing.py:128` *(default)* |
| `ANTHROPIC_API_KEY` | config, core | `disbot/config.py:161` *(default)*<br>`disbot/core/runtime/ai/providers/anthropic_provider.py:93` *(default)* |
...
| `BTD6_DATA_BACKEND` | config | `disbot/config.py:204` *(default)* |
| `BTD6_DATA_BASE_URL` | config | `disbot/config.py:207` *(default)* |
| `BTD6_DATA_CACHE_DIR` | config | `disbot/config.py:210` *(default)* |
...
| `OPENAI_API_KEY` | config, core, services | `disbot/config.py:160` *(default)*<br>`disbot/core/runtime/ai/providers/openai_provider.py:74` *(default)*<br>`disbot/services/setup_ai_advisor.py:175` *(default)*<br>`disbot/services/setup_ai_advisor.py:406` *(default)* |
