...
| Variable | Layers | Usages |
|---|---|---|
| `AI_DEFAULT_PROVIDER` | config, core | `disbot/config.py:184` *(default)*<br>`disbot/core/runtime/ai/feature_flags.py:66` *(default)* |
| `AI_ENABLED` | config | `disbot/config.py:183` *(default)* |
| `AI_FALLBACK_PROVIDER` | core | `disbot/core/runtime/ai/routing.py:128` *(default)* |
| `ANTHROPIC_API_KEY` | config, core | `disbot/config.py:167` *(default)*<br>`disbot/core/runtime/ai/providers/anthropic_provider.py:93` *(default)* |
...
| `BTD6_AUTO_SEED` | config | `disbot/config.py:222` *(default)* |
...
| `BTD6_DATA_BACKEND` | config | `disbot/config.py:210` *(default)* |
| `BTD6_DATA_BASE_URL` | config | `disbot/config.py:213` *(default)* |
| `BTD6_DATA_CACHE_DIR` | config | `disbot/config.py:216` *(default)* |
...
| `DISCORD_WEBHOOK_URL` | config | `disbot/config.py:109` *(default)* |
...
| `LOG_LEVEL` | config | `disbot/config.py:110` *(default)* |
| `OPENAI_API_KEY` | config, core, services | `disbot/config.py:166` *(default)*<br>`disbot/core/runtime/ai/providers/openai_moderation.py:68` *(default)*<br>`disbot/core/runtime/ai/providers/openai_provider.py:74` *(default)*<br>`disbot/services/setup_ai_advisor.py:175` *(default)*<br>`disbot/services/setup_ai_advisor.py:406` *(default)* |
| `PARAGON_API_BASE_URL` | config, services | `disbot/config.py:193` *(default)*<br>`disbot/services/paragon_service.py:49` *(default)* |
| `PARAGON_API_KEY` | config, services | `disbot/config.py:197` *(default)*<br>`disbot/services/paragon_service.py:50` *(default)* |
| `RAILWAY_GIT_COMMIT_SHA` | core | `disbot/core/runtime/command_manifest.py:243` *(default)* |
| `SETUP_ADVISOR_OPENAI_MODEL` | config, services | `disbot/config.py:165` *(default)*<br>`disbot/services/setup_ai_advisor.py:173` *(default)* |
| `SETUP_ADVISOR_PROVIDER` | config, core, services | `disbot/config.py:164` *(default)*<br>`disbot/core/runtime/ai/feature_flags.py:129` *(default)*<br>`disbot/services/setup_ai_advisor.py:393` *(default)* |
