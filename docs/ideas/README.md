...
- [`scheduler-independent-trigger-watchdog-2026-07-12.md`](./scheduler-independent-trigger-watchdog-2026-07-12.md) —
  **session ender (2026-07-12, overnight fleet review):** extend fleet-manager's roster-regen
  ...
  dropped one-shots, and dead pacemaker chains from a substrate the CCR scheduler can't take down.
...
- [`db-arg-type-binding-guard-2026-07-14.md`](./db-arg-type-binding-guard-2026-07-14.md) —
  **session ender (2026-07-14, 47th Q-0107 reconciliation pass, band-#2100):** an AST call-site guard
  ...
  BIGINT `user_id`) and flags a wrong-type argument at the call site — the CI-tier catch for the
  str/BIGINT class that #2089 (`!mine` `DataError`) escaped because the unit test mocked the DB.
  Friction→guard (enforce, don't exhort). Subsystem: tooling / self-improving workflow (S3).
