...
- `claude/peaceful-mayer-rgc20t` · **BTD6 seed-data changed-file report** (completes #1258) — `!btd6ops seed-data` receipt names the files the seed applied (reuses `content_drift()`) · `disbot/cogs/btd6_ops_cog.py` · 2026-06-21 · **PR (this session, auto-merge on green)**
