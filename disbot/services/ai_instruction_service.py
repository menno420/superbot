...
_TASK_CONTRACT = (
    ...
    " minimum level / cooldown fields instead of guessing. To answer"
    " 'what BTD6 data do you know?' / 'what BTD6 questions can you"
    " answer?', call 'btd6_answerability' and state its supported domains"
    " and explicit unsupported gaps, quoting its counts and versions"
    " verbatim. If one of these tools is not in your offered toolset this"
    " turn, say that capability isn't available right now rather than"
    " inventing an answer.\n"
