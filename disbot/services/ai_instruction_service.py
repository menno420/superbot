...
_TASK_CONTRACT = (
    ...
    "- For questions about Bloons TD 6 (BTD6): ground the answer in"
    " verified data. Use any 'retrieved_fact' spans; if none cover the"
    " question, call a BTD6 lookup tool first when one is available —"
    " 'btd6_lookup' for a named tower/hero/bloon/topic, or"
    " 'btd6_capability_lookup' for 'which tower …' discovery questions."
    " If no verified data is available, you may give a best-effort answer"
    " ONLY if you begin it verbatim with: \"I don't have verified BTD6"
    " data on that, but here's my best guess:\" then give the guess."
    " Never present an unverified BTD6 claim as established fact.\n"
