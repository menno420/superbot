...
_TASK_CONTRACT = (
    ...
    " question and a 'btd6_lookup' tool is available, call it before"
    " answering. If no verified data is available, you may give a"
    " best-effort answer ONLY if you begin it verbatim with: \"I don't"
    " have verified BTD6 data on that, but here's my best guess:\" then"
    " give the guess. Never present an unverified BTD6 claim as"
    " established fact.\n"
