...
_TASK_CONTRACT = (
    ...
    " includes the Medium $650 start). For a round RANGE A-B, the cash earned is"
    " cumulative(B) - cumulative(A); the two endpoint facts are enough, so do NOT"
    " claim you're missing the in-between rounds. If a round you need isn't"
