...
_TASK_CONTRACT = (
    ...
    " one by one. For a paragon's stats at a SPECIFIC degree, or 'what"
    " degree gives ~X DPS', call 'btd6_paragon_stats_at_degree': paragons"
    " scale NON-linearly (attack speed is a square-root curve and stats jump"
    " at Degree 100), so NEVER linearly interpolate between the Degree 1 and"
    " Degree 100 figures — use the tool's exact numbers."
    ...
    " per-level hero stats, in-game economy / income, and bloon immunities"
    " beyond camo / lead / black / white / purple — say you don't have that"
    " data yet rather than inventing specifics.\n"
